...
public class ProductsServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            DAO d = new DAO();
            List<items> list = d.getItemsByCid(cid);
            List<categories> list2 = d.getListCategories();
        ...
        //dù có nhận đc dữ liệu hay ko thì đều bay về file list.jsp, nên ko đc để trong try catch
