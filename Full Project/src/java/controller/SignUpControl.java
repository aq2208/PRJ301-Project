...
public class SignUpControl extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (!pass.equals(repass)) {
            ms1 = "Re-password is not correct!";
            check = false;
        }
        
        u = d.checkAccountExist(user);
        if(u != null) {
            ms2 = "Username existed!";
            check=false;
        }
        ...
        try {
            ...
            ms3 = "Invalid Phone Number!";
            check=false;
        }
        
        if(check==false) {
            request.setAttribute("error1", ms1);
            request.setAttribute("error2", ms2);
            request.setAttribute("error3", ms3);
            ...
            d.addUsers(user, pass, email, address, phone);
