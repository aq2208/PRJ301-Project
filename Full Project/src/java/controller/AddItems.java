...
public class AddItems extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            if(i==null) {
                items iNew = new items(item_id, item_name, description, price, stock, c, image);
                dao.insert(iNew);
                request.setAttribute("error", "Add new product successful!");
                request.getRequestDispatcher("additems.jsp").forward(request, response);
            } else {
                request.setAttribute("error", item_id + " existed");
                request.getRequestDispatcher("additems.jsp").forward(request, response);
            }
